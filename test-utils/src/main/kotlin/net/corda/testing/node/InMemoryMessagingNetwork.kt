...
class InMemoryMessagingNetwork(
    ...
    // Holds the mapping from node's X500Name to PeerHandle. It should be mapping from Party, but too much plumbing.
    ...
    fun createNodeWithID(
        ...
        peersMapping[peerHandle.description] = peerHandle // TODO duplicates
    ...
    inner class InMemoryMessaging(private val manuallyPumped: Boolean,
        ...
        override fun getAddressOfParty(partyInfo: PartyInfo): MessageRecipients {
            return when (partyInfo) {
                is PartyInfo.Node -> peersMapping[partyInfo.party.name]!! // TODO remove null
