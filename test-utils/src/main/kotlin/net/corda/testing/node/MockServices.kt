...
open class MockServices(vararg val keys: KeyPair) : ServiceHub {
    ...
    override val myInfo: NodeInfo get() = NodeInfo(listOf(HostAndPort.fromHost("localhost")), setOf(getTestPartyAndCertificate(MEGA_CORP.name, key.public)), MOCK_VERSION_INFO.platformVersion)
